...
d3.csv("multi_graph.csv", function(data) {
...
// Draw the lines for the chosen companies
function lines() {
  x = d3.time.scale().range([0, w - 60]);
  y = d3.scale.linear().range([h / 10 - 20, 0]);
  ...
  var g = svg.selectAll(".symbol")
      .attr("transform", function(d, i) { return "translate(0," + (i * h / 10 + 10) + ")"; });
...
function horizons() {
  ...
  g.select("circle").transition()
      .duration(duration)
      .attr("transform", function(d) { return "translate(" + (w - 60) + "," + (-h / 10) + ")"; })
      .remove();

  g.select("text").transition()
      .duration(duration)
      .attr("transform", function(d) { return "translate(" + (w - 60) + "," + (h / 10 - 20) + ")"; })
      .attr("dy", "0em");
  ...
  g.each(function(d) {
    ...
    d3.select(this).selectAll(".area")
      ...
      .enter().insert("path", ".line")
        .attr("class", "area")
        .attr("transform", function(d) { return "translate(0," + (d * (h / 10 - 20)) + ")"; })
...
//Donut explode to reset the animation
